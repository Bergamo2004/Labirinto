...
public class GeneraMappa {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Inserisci numero mappa:");
			System.out.print("> ");
			n = sc.nextInt();
			file = new File("res\\maps\\img\\mp" + n + ".png");
			if(n<10)
				 writer = new FileWriter("res\\maps\\map0" + n + ".txt");
			else
				writer = new FileWriter("res\\maps\\map" + n + ".txt");
			...
			System.out.println("Errore: Mappatura Fallita");
		}
	}
}
